...
class ExpArgs:
    ...
    explained_model_name_or_path = None
    interpreter_model_name_or_path = None
    explained_tokenizer_name_or_path = None
    interpreter_tokenizer_name_or_path = None
...
class BackbonesMetaData:
    name = {  #
        ...
        ModelBackboneTypes.CAUSAL_LM.value: "model"  #
    }
